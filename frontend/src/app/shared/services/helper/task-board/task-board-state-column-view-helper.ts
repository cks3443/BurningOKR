...
export class TaskBoardStateColumnViewHelper extends TaskService {
  ...
  createStateTaskMapList(
    states: ViewTaskState[],
    tasks: ViewTask[],
    defaultStateTaskMap?: StateTaskMap,
  ): StateTaskMap[] {
  ...
  getMovedTaskWithNewPositionData(previousIndex: number, previousContainer: ViewTask[],
    currentIndex: number, currentContainer: ViewTask[], newTaskState: ViewTaskState,
  ): ViewTask {
  ...
  overwriteOneTaskListOfStateTaskMap(
